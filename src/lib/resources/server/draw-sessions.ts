...
export function newDrawSession(clockId: string, scriptId: string, seatCharacterIds: string[], bluffSets: string[][], offSeatIds: string[] = [], presetId: string | null = null): DrawSession {
    ...
    const session: DrawSession = { id: clockId, scriptId, bluffSets, offSeatIds, presetId, slots };
