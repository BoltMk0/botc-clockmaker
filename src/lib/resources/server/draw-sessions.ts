...
export function newDrawSession(clockId: string, scriptId: string, seatCharacterIds: string[], bluffIds: string[]): DrawSession {
    ...
    const session: DrawSession = { id: clockId, scriptId, bluffIds, slots };
